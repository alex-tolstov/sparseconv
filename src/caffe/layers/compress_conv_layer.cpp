...
//  std::string code = caffe::directConvolutionRegistersCodegenUnrolled(&nonZeroValues[0], &indicesX[0], &indicesChannel[0], this->kernel_h_, this->kernel_w_, this->channels_, this->num_output_);
//  std::stringstream fileName;
//  fileName << "/home/alex/paulsutter/code_reusage" << this->num_output_;
