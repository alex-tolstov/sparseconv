...
void CConvolutionLayerTesting<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void CConvolutionLayerTesting<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void CConvolutionLayerTesting<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {  
...
template <typename Dtype>
void CConvolutionLayerTesting<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(CConvolutionLayerTesting);
#endif

INSTANTIATE_CLASS(CConvolutionLayerTesting);
