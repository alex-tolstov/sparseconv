...
void runTraditional50(const Dtype *input, const int imgSizeX, const int imgSizeY, Dtype *output, const int outputPitchX, const int resSizeX, const int resSizeY);


template<> void runTraditional50<double>(const double *input, const int imgSizeX, const int imgSizeY, double *output, const int outputPitchX, const int resSizeX, const int resSizeY) {

}

template<> void runTraditional50<float>(const float *input, const int imgSizeX, const int imgSizeY, float *output, const int outputPitchX, const int resSizeX, const int resSizeY) {
    {
